#!/usr/bin/env python3
"""
Genera un PDF del Modelo 620 de Cataluna rellenado dibujando los valores sobre la plantilla.
...
Los argumentos por defecto ya apuntan al JSON de ejemplo, la estructura,
el mapeo y la plantilla dentro de este repositorio.
"""
